...
import { DirectemarMarineAlertsConnector } from "./directemar-marine-alerts";
...
export function createCountrySignalConnector(
  ...
  switch (sourceId) {
    ...
    case "cl.directemar.marine-weather-alerts":
      return new DirectemarMarineAlertsConnector();
